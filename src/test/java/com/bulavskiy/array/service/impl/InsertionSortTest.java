...
class InsertionSortTest {
  ...
  private static final ArraySortService insertionSort = new InsertionSort();

  static Stream<Arguments> provideArrayForInsertionSort() {
    return Stream.of(
  ...
  @ParameterizedTest
  @MethodSource("provideArrayForInsertionSort")
  void arraySort(Long id, int[] testArray, int[] expectedArray) {
    ...
    NewArray result = insertionSort.arraySort(newArray);
